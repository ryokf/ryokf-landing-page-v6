        ...
        <div className="pb-20 pt-36">
            ...
            <div className="flex justify-center relative my-20 z-10">
                <div className="max-w-[89vw] md:max-w-2xl lg:max-w-[60vw] flex flex-col items-center justify-center">
                    <h2 className='text-center md:tracking-wider text-sm md:text-lg lg:text-2xl'>Hello 👋, i&apos;am</h2>
                    <TextGenerateEffect
                        className='text-center text-[40px] md:text-5xl lg:text-6xl'
                        words='Ryo Khrisna Fitriawan'
                    ></TextGenerateEffect>
                    <p className='uppercase tracking-widest text-xs text-center text-blue-100 mb-4'>a software developer who specializes in frontend engineering.</p>
                    <a href="#about">
